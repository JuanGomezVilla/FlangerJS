...
class BarraCargando {
	/**
	 * Constructor. Datos: x, y, ancho, alto, grosor, color1, color2, velocidad
	 * mostrarTexto, onFinish (método)
	 * @constructor
	 * @param {*} datos 
	 */
	constructor(datos){
	...
	actualizar(){
		...
		if(this.mostrarTexto){
			utils.escribirTexto(
				...
				this.y + this.alto + 20,		//Uicación vertical del texto (debajo de la barra)
